...
public class Return extends javax.swing.JFrame {
    ...
    public void ReturnUpdate(){
        String sql="insert into Return where Student_ID, Student_Name,Father.Name,Course,Branch,Year,Semester,Book_ID,SName,Edition,Publisher,Price,Pages,DOI,DOR";
       try{
           pst=conn.prepareStatement(sql);
        ...
        pst.setString(14, jTextField14.getText());
         pst.setString(15, ((JTextField) dateChooserCombo1.getdateEditor().getUIComponent()).getText());
         pst.execute();
